...
function obtenerOpcionUsuario (){
 var respuesta=prompt("¿piedra, papel o tijera?");
 return respuesta;
}
...
/*function mostrarResultado(resultado){
    ...
    if(resultadoJuego == "ganaste"){
        nodoResultado = document.getElementById("victoria").cloneNode(true);
    } else if(resultadoJuego == "perdiste"){
        nodoResultado = document.getElementById("derrota").cloneNode(true);
    } else {
        nodoResultado = document.getElementById("empate").cloneNode(true);        
    }

    var aReemplazar = document.getElementById("resultado-juego");
    var padre = aReemplazar.parentNode;

    padre.replaceChild(nodoResultado,aReemplazar);

}

mostrarResultado();*/
var $resultado = $("#" + resultadoJuego); 
   $("#resultado-juego").append($resultado);   
